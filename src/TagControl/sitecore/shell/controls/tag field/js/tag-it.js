...
(function($) {
    ...
    $.widget('ui.tagit', {
            ...
            if (!addedExistingFromSingleFieldNode) {
                this.tagList.children('li').each(function() {
                    if (!$(this).hasClass('tagit-new')) {
                        ...
                        that.createTag($(this).text(),$(this).data('id'), $(this).attr('class'), true);
                        $(this).remove();
                    }
                });
            }
        ...
        createTag: function(value,id, additionalClass, duringInitialization) {
            var that = this;
            ...
            //addTagObject(selectedTags, id, value);
